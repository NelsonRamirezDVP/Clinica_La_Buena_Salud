<?php
  ...
  class PDF extends FPDF
  {
    ...
    function Footer()
    {
      ...
      $this->Cell(70,20,utf8_decode('Reporte donde se muestra la información de los registros almacenados en la base de datos de los insumos para los laboratorios disponibles ordenados por nombre de forma alfabética ascendente.'));
